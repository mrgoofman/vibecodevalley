...
Vibecode Valley is an online educational platform offering courses and resources related to building AI-powered web applications. The Service includes:
...
- Agree to receive email communications regarding course launches and updates
- Confirm that the email address provided is accurate and belongs to you
- Understand that waitlist registration does not guarantee course enrollment
- Can unsubscribe from communications at any time

## 4. Intellectual Property Rights

### 4.1 Our Content
All content, materials, and intellectual property on Vibecode Valley, including but not limited to:
- Course materials and curriculum
- Videos, text, graphics, and multimedia content
...
### 4.3 Restrictions
You may not:
- Reproduce, distribute, or sell course materials
...
You agree to use the Service in compliance with all applicable laws and regulations. Prohibited activities include:
...
### 6.1 Course Fees
Course fees will be clearly stated at the time of enrollment. All prices are in EUR unless otherwise specified.

### 6.2 Payment Processing
Payments are processed through secure third-party payment providers. We do not store your payment card information.

### 6.3 Refund Policy
Refund eligibility and terms will be specified for each course at the time of purchase. Generally, refunds may be requested within 14 days of purchase if less than 25% of the course has been accessed.
...
- Any conduct we deem harmful to the Service or our community
...
We reserve the right to modify these Terms and Conditions at any time. Changes will be effective immediately upon posting to the Service. Your continued use of the Service after changes are posted constitutes acceptance of the modified terms.

We will make reasonable efforts to notify users of material changes via email or prominent notice on the Service.
...
Any disputes arising from these Terms or your use of the Service shall be subject to the exclusive jurisdiction of the courts of Graz, Austria.
...
These Terms are provided in English. In case of any discrepancy between translated versions, the English version shall prevail.

---

*By using Vibecode Valley, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions.*
